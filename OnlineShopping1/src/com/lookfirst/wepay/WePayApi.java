...
//String x= "https://stage.wepay.com/v2/oauth2/authorize?client_id=7532&redirect_uri=http://www.google.co.in&scope=manage_accounts%2Cview_balance%2Ccollect_payments%2Crefund_payments%2Cview_user%2Cpreapprove_payments%2Csend_money&state=true&user_name=Rajeswari&user_email=rajeswari.android%40gmail.com";
		return uri;
	}
...
System.out.println("request ****" + request.getEndpoint());
		String token = "STAGE_146eb507c1e6337d6eb0bc46c526388b0118e74b18439ce4a29d33a56c60a404";
	...
	public <T> T execute(String token, WePayRequest<T> req) throws IOException, WePayException {
		...
		//+"?{"+"\"" +"access_token" +"\""+":STAGE_05b2feb5c5239c6b051f7de1cf3131852e149edcb3eb118645bb450d53f83485}";
